...
const SELECT_CLS =
  "text-[16px] sm:text-xs rounded-full border border-white/10 bg-white/5 text-slate-200 pl-3 pr-8 py-2 hover:border-white/20 focus:outline-none focus:ring-2 focus:ring-[#ff2d87]/50 appearance-none bg-no-repeat bg-[right_0.75rem_center] bg-[length:0.65rem] cursor-pointer";
